<script>
  import {isDarkMode, setDarkMode} from '../data/setting';
</script>

<label class="swap swap-rotate btn btn-ghost text-primaryText dark:text-secondaryTextDark">
    <!-- this hidden checkbox controls the state -->
    <input type="checkbox"  bind:checked={$isDarkMode} on:change={() => {setDarkMode($isDarkMode)}} />
